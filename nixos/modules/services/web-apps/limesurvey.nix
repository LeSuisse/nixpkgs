  ...
  limesurveyConfig = pkgs.writeText "config.php" ''
    <?php
      return \array_merge(
        ...
        [
          'config' => [
            'encryptionnonce' => \file_get_contents(\getenv('CREDENTIALS_DIRECTORY') . DIRECTORY_SEPARATOR . 'encryption_nonce'),
            'encryptionsecretboxkey' => \file_get_contents(\getenv('CREDENTIALS_DIRECTORY') . DIRECTORY_SEPARATOR . 'encryption_key'),
          ]
        ]
      );
    ?>
